...
class ConditionalUnet1D(nn.Module):
    ...
    def __init__(self, input_dim, global_cond_dim, diffusion_step_embed_dim=256,
        ...
        diffusion_step_encoder = nn.Sequential(
            ...
            SinusoidalPosEmb(dsed, torch.float16),  # no dtype forced
    ...
    def forward(self,
        ...
        timesteps = timesteps.to(dtype=next(self.diffusion_step_encoder.parameters()).dtype, device=sample.device)
        # timesteps = timesteps.half().to(sample.device)
